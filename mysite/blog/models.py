...
class OrderItem(models.Model):
    lg = models.ForeignKey(LG, blank=True, on_delete=models.CASCADE)
    samsung = models.ForeignKey(Samsung_TV, blank=True, on_delete=models.CASCADE)
    sony = models.ForeignKey(Sony, blank=True, on_delete=models.CASCADE)
    panasonic = models.ForeignKey(Panasonic, blank=True, on_delete=models.CASCADE)
    apple = models.ForeignKey(Apple, blank=True, on_delete=models.CASCADE)
    samsung = models.ForeignKey(Samsung, blank=True, on_delete=models.CASCADE)
    xiaomi = models.ForeignKey(Xiaomi, blank=True, on_delete=models.CASCADE)
    mac_os = models.ForeignKey(Mac_OS, blank=True, on_delete=models.CASCADE)
    asus = models.ForeignKey(ASUS, blank=True, on_delete=models.CASCADE)
    acer = models.ForeignKey(ACER, blank=True, on_delete=models.CASCADE)
    title = models.CharField(max_length=100, blank=True)
